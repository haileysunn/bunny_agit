  ...
  return (
    <div className="relative w-full h-full">
      ...
      <button
        ...
        className="absolute bottom-8 left-4 md:bottom-6 md:left-6 bg-white text-bunny-primary p-2 md:p-3 rounded-full shadow-lg hover:bg-gray-100 transition z-50 text-xl md:text-2xl"
        title="내 위치로 이동"
      >
        📍
      </button>
